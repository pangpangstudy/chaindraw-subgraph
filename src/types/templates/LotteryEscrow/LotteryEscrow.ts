...
export class LotteryEscrow__s_requestsResult {
  value0: BigInt;
  value1: boolean;
...
export class LotteryEscrow extends ethereum.SmartContract {
  static bind(address: Address): LotteryEscrow {
    return new LotteryEscrow("LotteryEscrow", address);
  }
  ...
  s_requests(param0: BigInt): LotteryEscrow__s_requestsResult {
    let result = super.call(
      "s_requests",
    ...
    return new LotteryEscrow__s_requestsResult(
      result[0].toBigInt(),
      result[1].toBoolean(),
    );
  }
  ...
  try_s_requests(
    param0: BigInt,
  ): ethereum.CallResult<LotteryEscrow__s_requestsResult> {
    let result = super.tryCall(
      "s_requests",
      "s_requests(uint256):(uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    return ethereum.CallResult.fromValue(
      new LotteryEscrow__s_requestsResult(
        value[0].toBigInt(),
        value[1].toBoolean(),
      ),
    );
